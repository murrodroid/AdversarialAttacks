...
class SSIM:
    ...
    def evaluate(self, img1: torch.Tensor, img2: torch.Tensor, window_size: int = 11, sigma: float = 1.5) -> float:
        '''
        ...
        window = self.create_gaussian_kernel(window_size, sigma, channels).to(img1.device)
