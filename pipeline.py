...
def run_single_generation(config):
    ...
    attack_kwargs = {"epsilon": epsilon, "break_early": True}
    if attack_name == "fgsm":
...
def run_pipeline(args):
    ...
    # Each configuration will process ALL examples for that combination in a single batch
